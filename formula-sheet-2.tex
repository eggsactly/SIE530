...
\end{cases}$$
The \emph{Power Function} of a hypothesis test with rejection region $R$ is the function of $\theta$ defined by $\beta(\theta)=P_\theta(X\in R)$.
...
Bernolli $\rightarrow$ Binomial\\
Exponential $\rightarrow$ Gamma\\
