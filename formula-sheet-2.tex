...
An estimator $W*$ is a best \emph{unbiased} estimator of $\tau(\theta)$ if it statisfies $E_\theta W* = \tau(\theta), \forall \theta$ and for any other estimator $W$ with $E_\theta W = \tau(\theta)$ we have $Var_\theta W* \leq Var_\theta W$
